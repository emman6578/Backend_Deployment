...
exports.purchase_report = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (format === "excel") {
        ...
        const reportsDir = path_1.default.join(process.cwd(), "public/reports");
