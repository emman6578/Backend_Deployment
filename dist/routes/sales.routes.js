...
//Create
router.post("/", authMiddleware_1.authenticateToken, (0, roleMiddleware_1.authorizeRoles)(["SUPERADMIN", "ADMIN"]), sales_controller_1.create);
//Create Sales Return
router.post("/return", authMiddleware_1.authenticateToken, (0, roleMiddleware_1.authorizeRoles)(["SUPERADMIN", "ADMIN"]), sales_controller_1.createSalesReturn);
//Read
