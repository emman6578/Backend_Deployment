...
//Create
router.post("/", authMiddleware_1.authenticateToken, (0, roleMiddleware_1.authorizeRoles)(["SUPERADMIN", "ADMIN"]), uploadMiddleware_1.uploadProductImages.array("images", 50), // This expects field name 'images' for all files
...
//Update
router.put("/:id", authMiddleware_1.authenticateToken, (0, roleMiddleware_1.authorizeRoles)(["SUPERADMIN", "ADMIN"]), uploadMiddleware_1.uploadProductImages.array("images", 1), // Expect image field
